...
class MarkSheetB{
    Integer physicsMask, mathermaticsMask, chemistryMask, englishMask, hindiMask, averageMask;
    ...
    public void averageMasks(){
        System.out.println("Average Marks = "+( (physicsMask + mathermaticsMask + chemistryMask + englishMask + hindiMask)/ 5) );
    }
}

public class FindAverageMarks {
    public static void main(String[] args) {
        MarkSheetB obj = new MarkSheetB();
